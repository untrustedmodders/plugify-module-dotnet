...
public partial class JitCall : SafeHandle
{
	...
	public unsafe delegate* unmanaged[Cdecl, SuppressGCTransition]<nint*, nint*, void> Function => (delegate* unmanaged[Cdecl, SuppressGCTransition]<nint*, nint*, void>) GetCallFunction(handle);
